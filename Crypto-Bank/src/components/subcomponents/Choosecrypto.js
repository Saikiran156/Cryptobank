...
const Choosecrypto = () => {
  ...
  function simpleBank() {
    ...
    const tokendetails = jwt(jwttoken);
      ...
      <div className="w-3/4">
        ...
        <div className="flex justify-around place-content-center mr-20 mt-24">
          <div className="flex flex-col place-content-center justify-center mt-6">
            ...
            <button
              onClick={simpleBank}
              className="bg-primary rounded-full p-5 w-64 m-auto mt-10 outline-none shadow-md font-bold shadow-black text-white text-center text-2xl hover:bg-least"
            >
              ETHER
            </button>
          </div>
          ...
          <div
            className="flex flex-col place-content-center justify-center mt-6"
            style={{ width: 350 }}
          >
